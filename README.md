...
[![Version](https://img.shields.io/github/v/release/tene-ai/tene?color=green)](https://github.com/tene-ai/tene/releases)
[![CI](https://github.com/tene-ai/tene/actions/workflows/ci.yml/badge.svg)](https://github.com/tene-ai/tene/actions/workflows/ci.yml)
...
**Your .env is not a secret. AI can read it.** | [Website](https://tene.sh) | [For AI Agents ↓](#for-ai-agents) | [Releases](https://github.com/tene-ai/tene/releases) | [More demos ↓](#-more-demos)
...
Download from [GitHub Releases](https://github.com/tene-ai/tene/releases), then:
