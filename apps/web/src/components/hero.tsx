        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:mt-10 lg:items-start">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="https://www.producthunt.com/posts/tene?embed=true&utm_source=badge-featured&utm_medium=badge&utm_souce=badge-tene"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
                  src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=969857&theme=dark"
                  alt="Tene - Your .env is not a secret. Tene hides it from AI agents. | Product Hunt"
                  width="180"
                  height="40"
                />
              </a>
