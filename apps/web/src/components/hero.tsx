          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:mt-10 lg:items-start">
            ...
            <div className="flex w-full gap-3 sm:w-auto">
              <a
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-border px-5 py-3 text-sm font-medium transition-colors hover:bg-surface sm:flex-none"
              >
              ...
              <a
                href={heroData.cta.dashboard.href}
                className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-accent/30 bg-accent/10 px-5 py-3 text-sm font-medium text-accent transition-colors hover:bg-accent/20 sm:flex-none"
              >
                {heroData.cta.dashboard.label} &rarr;
              </a>
            </div>
          </div>
        </div>
