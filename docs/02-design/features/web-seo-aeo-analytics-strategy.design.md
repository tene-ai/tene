...
Policy: https://github.com/tene-ai/tene/blob/main/SECURITY.md
...
export const GA4_EVENTS = {
  ...
  GITHUB_REPO_CLICK:   'github_repo_click',       // any github.com/tene-ai/tene link
...
**Q4 — package.json Field Values**: Confirm: `homepage: "https://tene.sh"`, `repository: "https://github.com/tene-ai/tene"`, `author: "Kay Kim <kay@popupstudio.ai>"`, `description: "Landing page for Tene — local-first encrypted secret manager"`. Any corrections?
