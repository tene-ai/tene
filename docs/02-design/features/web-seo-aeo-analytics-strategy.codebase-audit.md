...
| P0-12 | package.json metadata | MOD | `apps/web/package.json` | Add `"homepage": "https://tene.sh"`, `"repository": { "type": "git", "url": "https://github.com/tene-ai/tene" }`, `"description": "Landing page for Tene — local-first encrypted secret manager"`, `"license": "MIT"`, `"author": "Kay Kim <kay@popupstudio.ai>"` (per PRD §7 Open Q) |
...
- `repository: "https://github.com/tene-ai/tene"` — OK?
