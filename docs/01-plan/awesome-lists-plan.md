...
```
* [tene](https://github.com/tene-ai/tene) — Local-first AI-safe secret manager CLI. XChaCha20-Poly1305 encryption, runtime env-var injection, auto-generates rules for Claude Code, Cursor, Windsurf.
```
