...
==> Downloading https://github.com/agent-kay-it/tene/releases/download/v0.1.0/tene_0.1.0_darwin_arm64.tar.gz
...
```bash
$ go install github.com/agent-kay-it/tene@latest
> go: downloading github.com/agent-kay-it/tene v0.1.0
